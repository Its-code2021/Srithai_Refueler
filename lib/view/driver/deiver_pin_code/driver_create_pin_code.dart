...
import 'package:cpac/view/driver/deiver_pin_code/driver_create_confirm_pin_code.dart';
...
void main() => runApp(Driver_Create_Pin_Code());

// ignore: use_key_in_widget_constructors
class Driver_Create_Pin_Code extends StatelessWidget {
                ...
                child: Padding(
                    ...
                    child: PinCodeTextField(
                      ...
                      onCompleted: (v) {
                        ...
                        driver_currentText_number = currentText;
                        var List_number;
                        for (var i = 0; i < numbers.length; i++) {
                          List_number = numbers[i];
                          if (driver_currentText_number == List_number) {
                            textEditingController.clear();
                            Alert__Create_Security_PinCode(context);
                          } else {
...
Future<void> Alert__Create_Security_PinCode(BuildContext context) async {
  showDialog(
      context: context,
