...
class Driver_Forgot_Confirm_Pin_Code extends StatelessWidget {
...
var Driver_currentText_Chang_Pin;
              ...
              Form(
                ...
                child: Padding(
                    ...
                    child: PinCodeTextField(
                      ...
                      onCompleted: (v) {
                        var id_pin_confirm = Profile['id'].toString();
                        if (Driver_currentText_Chang_Pin == currentText) {
                          PostAuth_Driver_Change_Pin(context,
                              Driver_currentText_Chang_Pin, id_pin_confirm);
                          print(
                              'TESTDriver_currentText_Chang_Pin :::: $Driver_currentText_Chang_Pin');
                        } else {
