...
class Staff_Draw_User_GEN extends StatefulWidget {
  @override
  _Staff_Draw_User_GENState createState() => new _Staff_Draw_User_GENState();
}

class _Staff_Draw_User_GENState extends State<Staff_Draw_User_GEN> {
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(Oil_Details['oil_truck'].toString(),
                                  style: TextStyle(
                                      fontWeight: FontWeight.bold,
                                      color: Colors.green)),
                              Text(
                          ...
                          Row(
                            children: [
                              ...
                              Text(Oil_Details['oil_gen'].toString(),
                                  style: TextStyle(
                                      fontWeight: FontWeight.bold,
                                      color: Colors.green)),
                              Text(
                          ...
                          Row(
                            children: [
                              ...
                              Text(Oil_Details['refuel_amount'].toString(),
                                  style: TextStyle(
                                      fontWeight: FontWeight.bold,
                                      color: Colors.green)),
                              Text(
                        ...
                        children: [
                          ElevatedButton(
                            onPressed: () {
                              ...
                              var refuel_amount =
                                  Oil_Details['refuel_amount'].toString();
