...
class Gas_Screenshot_Payment extends StatefulWidget {
  const Gas_Screenshot_Payment(bin_detail_id, {Key? key}) : super(key: key);

  @override
  _Gas_Screenshot_PaymentState createState() => _Gas_Screenshot_PaymentState();
}

class _Gas_Screenshot_PaymentState extends State<Gas_Screenshot_Payment> {
                  ...
                  children: [
                    TableRow(children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          Paymant_Slip_Detail['payment_id'].toString(),
                    ...
                    TableRow(children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          Paymant_Slip_Detail['Site_name'].toString() +
                              '/' +
                              Paymant_Slip_Detail['Business_name'].toString(),
                          textAlign: TextAlign.start,
                          maxLines: 2,
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: Text(
                              Paymant_Slip_Detail['Company_name'].toString(),
                              textAlign: TextAlign.start,
                              maxLines: 2,
                              overflow: TextOverflow.ellipsis,
                              style: TextStyle(
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: Text(
                              Paymant_Slip_Detail['sdate'].toString() +
                                  ' ถึง ' +
                                  Paymant_Slip_Detail['edate'].toString(),
                              textAlign: TextAlign.start,
                              maxLines: 2,
                              overflow: TextOverflow.ellipsis,
                              style: TextStyle(
                    ...
                    TableRow(children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          NumberFormat("#,###.##")
                              .format(Paymant_Slip_Detail['bill_amount']),
                          textAlign: TextAlign.start,
                          style: TextStyle(
                              fontWeight: FontWeight.bold,
                              color: Color(0xff438EB9)),
                    ...
                    TableRow(children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          Paymant_Slip_Detail['created_name'].toString(),
                          textAlign: TextAlign.start,
                          style: TextStyle(
                              fontWeight: FontWeight.bold,
                              color: Color(0xff438EB9)),
                    ...
                    TableRow(children: [
                      ...
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.end,
                        children: [
                          if (Paymant_Slip_Detail['payment_method'] == "1") ...{
                            Row(
                              children: [
                                Container(
                                  width: 150,
                            ...
                            //       ),
                            //       child: Text(
                            //         Paymant_Slip_Detail['card_no'].toString(),
                            //         textAlign: TextAlign.start,
                            //         maxLines: 2,
                            //         overflow: TextOverflow.ellipsis,
                            //         style: TextStyle(
                    ...
                    TableRow(children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          Paymant_Slip_Detail['fullname'].toString(),
                          textAlign: TextAlign.start,
                          style: TextStyle(
                              fontWeight: FontWeight.bold,
                              color: Color(0xff438EB9)),
