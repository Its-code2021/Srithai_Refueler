...
class Forgot_Confirm_Pin_Code extends StatelessWidget {
                ...
                child: Padding(
                    ...
                    child: PinCodeTextField(
                      ...
                      onCompleted: (v) {
                        ...
                        if (currentText_Chang_Pin == currentText) {
                          PostAuth_Change_Pin(
                              context, currentText_Chang_Pin, id_pin_confirm);
                          print(
                              'TESTcurrentText_Chang_Pin :::: $currentText_Chang_Pin');
                        } else {
