...
class Gas_Create_Confirm_Pin_Code extends StatelessWidget {
  Gas_Create_Confirm_Pin_Code();
                ...
                child: Padding(
                    ...
                    child: PinCodeTextField(
                      ...
                      onCompleted: (v) {
                        ...
                        if (currentText_number == currentText) {
                          PostAuth_Check_Created_Pin(
                              context, currentText_number, id_pin);
                          print(
                              'TESTcurrentText_number :::: $currentText_number');
                        } else {
