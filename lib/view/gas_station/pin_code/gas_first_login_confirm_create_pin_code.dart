...
class Gas_FirstLogin_Confirm_Create_Pin_Code extends StatelessWidget {
  Gas_FirstLogin_Confirm_Create_Pin_Code();
...
var currentText_FirstLogin_Number;
              ...
              Form(
                ...
                child: Padding(
                    ...
                    child: PinCodeTextField(
                      ...
                      onCompleted: (v) {
                        var First_id_pin = Profile['id'].toString();
                        if (currentText_FirstLogin_Number == currentText) {
                          PostAuth_First_Created_Pin(context,
                              currentText_FirstLogin_Number, First_id_pin);
                          print(
                              'TESTcurrentText_number :::: $currentText_FirstLogin_Number');
                        } else {
