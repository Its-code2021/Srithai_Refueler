...
import 'gas_first_login_confirm_create_pin_code.dart';

void main() => runApp(Gas_FirstLogin_Create_Pin_Code());

// ignore: use_key_in_widget_constructors
class Gas_FirstLogin_Create_Pin_Code extends StatelessWidget {
              ...
              Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      'กรุณาตั้งรหัส PIN เมื่อเข้าสู่ระบบครั้งแรกเพื่อความปลอดภัยของคุณ',
                      style: TextStyle(
                        color: Colors.red,
                        fontWeight: FontWeight.bold,
                        fontSize: 18,
              ...
              Form(
                ...
                child: Padding(
                    ...
                    child: PinCodeTextField(
                      ...
                      onCompleted: (v) {
                        currentText_FirstLogin_Number = currentText;
