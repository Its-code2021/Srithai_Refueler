...
class DriverTruck_Forgot_Confirm_Pin_Code extends StatelessWidget {
...
var DriverTruck_currentText_Chang_Pin;
              ...
              Form(
                ...
                child: Padding(
                    ...
                    child: PinCodeTextField(
                      ...
                      onCompleted: (v) {
                        var id_pin_confirm =
                            Driver_ProfileUser['id'].toString();
                        if (DriverTruck_currentText_Chang_Pin == currentText) {
                          PostAuthDriver_Truck_Change_Pin(
                              context,
                              DriverTruck_currentText_Chang_Pin,
                              id_pin_confirm);
                          print(
                              'TESTDriverTruck_currentText_Chang_Pin :::: $DriverTruck_currentText_Chang_Pin');
                        } else {
