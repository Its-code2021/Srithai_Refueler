...
import 'package:cpac/view/truck_driver/pin_code_driver/driver_truck_forgot_confirm_pint_code.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';

import 'package:pin_code_fields/pin_code_fields.dart';

void main() => runApp(DriverTruck_Forgot_Pin_Code());

// ignore: use_key_in_widget_constructors
class DriverTruck_Forgot_Pin_Code extends StatelessWidget {
                ...
                child: Padding(
                    ...
                    child: PinCodeTextField(
                      ...
                      onCompleted: (v) {
                        ...
                        DriverTruck_currentText_Chang_Pin = currentText;

                        var List_number;
                        for (var i = 0; i < numbers.length; i++) {
                          List_number = numbers[i];
                          if (DriverTruck_currentText_Chang_Pin ==
                              List_number) {
                            ...
                            Navigator.of(context).pushAndRemoveUntil(
                                MaterialPageRoute(
                                    builder: (context) =>
                                        DriverTruck_Forgot_Confirm_Pin_Code()),
                                (Route<dynamic> route) => false);
                          }
                        }
                      },
